...
import hu.laszlolukacs.searchalgorithms.implementations.*;
...
public class SearchInputParser {
    ...
    private Graph graph = new SymmetricDirectedGraph();
     ...
     */
	private void processInputFileContents(BufferedReader reader) throws NullPointerException {
        if (reader == null) {
    ...
    private Edge parseEdge(final String currentLine) throws InvalidParameterException {
        ...
        return Edge.parseFromStrings(edgeStrings[0], edgeStrings[1], edgeStrings[2]);
    }
